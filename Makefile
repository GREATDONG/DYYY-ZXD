...
# 优化模块（可选）
DYYY_OPTIONAL_FILES = DYYYSwiftHookManager.m DYYYSwiftHooksSafe.m DYYYVideoHooks.xm DYYYCommentHooks.xm DYYLiveHooks.xm DYYYUIHooks.xm

# 如果启用优化模块
ifeq ($(WITH_OPTIMIZATION),true)
    DYYY_FILES += $(DYYY_OPTIONAL_FILES)
endif
